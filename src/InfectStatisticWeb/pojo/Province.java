...
public class Province 
{
    ...
    public Province(Province source)
    {
        ...
        this.critically = source.critically;
    ...
    //重症患者增加
    public void addCr(String str)
    {
        str = str.substring(0, str.length()-1);
        critically += Integer.parseInt(str);
    }
    //重症患者减少
    public void removeCr(String str)
    {
        str = str.substring(0, str.length()-1);
        critically -= Integer.parseInt(str);
    }
    ...
    public int[] getData()
    {
        int[] data = new int[]{infection,suspected,critically,allInfection,cure,dead};
        return data;
    }
